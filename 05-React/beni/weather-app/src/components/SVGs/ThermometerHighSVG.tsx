...
const ThermometerHighSVG = ({ className }: svgPropType) => {
  return (
    <svg
      className={className}
      width="43"
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="14.5792" y="8" width="4.64483" height="60" rx="2.32241" fill="currentColor" />
      <path
...
export default memo(ThermometerHighSVG);
