	...
	return (
		<div className="left-navbar">
			...
			<div className="left-navbar-links">
				...
				<div tabIndex="1" className="search links-basic-styles">
					<svg
						fill="currentColor"
						height="24"
						role="img"
				...
				<div tabIndex="1" className="explore links-basic-styles">
					<svg
						fill="currentColor"
						height="24"
						role="img"
				...
				<div tabIndex="1" className="reels links-basic-styles">
					<svg
						aria-label="Reels"
				...
				<div tabIndex="1" className="links-basic-styles">
					<svg
				...
				<div tabIndex="1" className="notifications links-basic-styles">
					<svg
				...
				<div tabIndex="1" className="create links-basic-styles">
					<svg
						aria-label="New post"
						class="x1lliihq x1n2onr6 x5n08af"
						fill="currentColor"
				...
				<div tabIndex="1" className="profile links-basic-styles">
