...
function CreatNewPost({show, onClose}: PopupProps): ReactNode {
    ...
    return(
      ...
      <div className="headerCreateContainer">
        ...
        <div className="closeOrSave" onClick={handleSharePost}>Share</div>
			</div>
      <div className="CreateContainer">
          ...
          <div className="ContentDetails">
              <div className="profil">
                ...
                <div className="userName">elish</div></div>
...
export default memo(CreatNewPost);