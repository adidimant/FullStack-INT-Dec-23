...
*/
class HashTable {
    constructor(hashFunction, keyName) {
        this.data = {};
    ...
    save(key, value) {
        ...
        const existingValueIndex = this.data[hashedValue].findIndex((entity) => entity[this.keyName] == key); // ~O(1)
...
12839761837462384746 % 10;
6;
// collisions example - both point to the same cell in the table
12839761837462384757 % 10;
7;
128397618374624757 % 10;
7;
function hashByModulo10(num) {
    return num % 10;
}
function hashByModulo100(num) {
    return num % 100;
}
function hashByCustomModulo(modulo) {
    return (num) => {
        return num % modulo;
    };
}
...
const hashTable = new HashTable(hashBy1000Modulo, 'id');
const userData = {
    id: 378594857,
    firstName: 'Adi',
    lastName: 'Dimant',
