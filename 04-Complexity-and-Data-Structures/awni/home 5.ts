...
function find<T>(root: TreeNode<T>, value: T): TreeNode<T> | null {
...
function insert<T>(root: TreeNode<T>, value: T): void {
...
function remove<T>(root: TreeNode<T> | null, value: T): TreeNode<T> | null {
    if (root === null) {
