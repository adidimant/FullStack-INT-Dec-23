...
class Utils {
  ...
  static getStatistics() {
    ...
    static arrayToObject(arr: []): Object {
    ...
    static getRandomInt(min: number, max: number): number | undefined {
         if (max > min) {
    ...
    static dateDiffInDays(date1: Date, date2: Date): number {
        ...
        let differenceBetweenDatesInmilliseconds: number;
        ...
        const differenceInDays: number = differenceBetweenDatesInmilliseconds / 1000 / 60 / 60 / 24;
