...
const geolocation_1 = require("./classes/regular_collectors/geolocation");
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        document.addEventListener('acme-sdk-loaded', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const intervalId = setInterval(() => {
                ...
                // geolocation
                document.getElementById('geolocation').innerHTML = 'geolocation: <span style="color: red">' + data[collectors[17].getKey()] + '</span>';
                // doNotTrack
                document.getElementById('doNotTrack').innerHTML = 'Do not track: <span style="color: red">' + data[collectors[18].getKey()] + '</span>';
                // battery
                document.getElementById('battery').innerHTML = 'Battery: <span style="color: red">' + data[collectors[19].getKey()] + '</span>';
                // currentUrl
                document.getElementById('currentUrl').innerHTML = 'Current Url: <span style="color: red">' + data[collectors[20].getKey()] + '</span>';
                // historyLength
                document.getElementById('historyLength').innerHTML = 'History length: <span style="color: red">' + data[collectors[21].getKey()] + '</span>';
                // colorDepth
                document.getElementById('colorDepth').innerHTML = 'Color depth: <span style="color: red">' + data[collectors[22].getKey()] + '</span>';
                // touchSupport
                document.getElementById('touchSupport').innerHTML = 'Touch support: <span style="color: red">' + data[collectors[23].getKey()] + '</span>';
                // mouseMove
                let MouseMovements = '';
