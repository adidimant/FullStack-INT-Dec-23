...
class PT {
    ...
    calculateDistancev2(x1: number | PT, y1?: number): number {
        let distX: number;
        let distY: number;
    ...
    calculateIncline(x1: number | PT, y1?: number): number {
        let distX: number;
        let distY: number;
    ...
    calculateMiddlePoint(x: number | PT, y?: number): PT {
        ...
        const x3: number = (x1 + x2) / 2;
        const y3: number = (y1 + y2) / 2;
